...
abline(lm(data= as.data.frame(data), mass~wingspan))
...
read.csv("iris.csv") # this prints it directly to the screen. we want to save it to an object
setwd("../Desktop/Data_Course/Code_Examples/R_Intro/")
getwd()
...
bigsepals <- iris$Sepal.Length > 5
iris[bigsepals,]

iris$Species == "virginica"

iris$Sepal.Length > 5 & iris$Species == "virginica"
